...
struct FaceIDRegistrationView: View {
    ...
    /// Siguiente pose por capturar, en el mismo orden que recorre el motor.
    private var nextPendingPose: FacePoseBucket? {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    // Anillo de tramos al estilo del registro de Face ID: cada
                    // sector se enciende al capturar su ángulo de cabeza, en vez
                    // de un único arco de progreso.
                    FaceIDPoseRing(
